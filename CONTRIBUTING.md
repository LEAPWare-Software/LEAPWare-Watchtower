...
powershell -NoProfile -ExecutionPolicy Bypass -File tests\supervision.ps1         # send_liveness_gate, completion_audit, orphan_watch, 67
powershell -NoProfile -ExecutionPolicy Bypass -File tests\setup_merge.ps1         # the installer's statusline + hooks merge, 203
powershell -NoProfile -ExecutionPolicy Bypass -File tests\stop_behaviour.ps1      # the two turn-end hooks, 133
