...
discloses, `metrics_behaviour.ps1` covers the transcript indexer and the scoreboard behind
`/lw-watchtower:metrics`, and `stack_mode.ps1` covers the working-discipline injector. The other three, `workflow_guard.ps1`,
